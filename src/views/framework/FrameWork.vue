...
<v-btn icon @click="toggleDrawer" >
  ...
  <v-navigation-drawer v-model="drawer" class="br-teal-darken-4" theme="dark">
      <v-list>
        ...
        <v-list-item link to="/vuetify" title="VUETIFY" prepend-icon="mdi-arrange-bring-to-front"></v-list-item>
        <v-list-item link to="/angular" title="ANGULAR" prepend-icon="mdi-arrange-send-to-back"></v-list-item>
