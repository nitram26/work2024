  ...
  <template>
  <MainLayout>
     <template #main> <h1>HOME FRONT</h1> </template>
     <template #image1>  <a href="/html" class="lat">HTML</a> </template>
     <template #image2>  <a href="/javascript" class="lat">JAVASCRIPT</a> </template>
     <template #image3>  <a href="/vue2" class="lat">VUE2</a> </template>
     <template #image4>  <a href="/vue3" class="lat">VUE3</a> </template>
