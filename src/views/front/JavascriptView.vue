...
<v-btn icon @click="toggleDrawer" >
  ...
  <v-navigation-drawer v-model="drawer" class="br-teal-darken-4" theme="dark">
      <v-list>
        ...
        <v-list-item ><v-btn @click="scrollTo('section1')" prepend-icon="mdi-arrange-bring-to-front">FECHA Y HORA</v-btn></v-list-item>
    ...
    max-width="344" >
    <v-card-item>
      <v-card-title class="text-red"> FECHA ACTUAL  </v-card-title>
      <v-card-subtitle>traer la fecha y hora actual</v-card-subtitle>
    </v-card-item>
    <v-card-text>
     Formater para quedarse con la fecha DD/MM/YYYY
    </v-card-text>
  </v-card>
  </v-col>
      </v-row>
