<template>
    ...
    <v-row>
      <v-col cols="12" >
        <h2 class="bg-red-darken-4 pa-4">Vue2 MODELS -TEXT HTML</h2>
      <p class="bg-orange-lighten-4 pa-4 mb-4">Modelos en proceso de optimización, solo para pruebas. Buscar un modelo que sirva para todos lo casos </p>
      </v-col>
    </v-row>
      <v-row>
...
<!-- ****************************************************************************** -->
    ...
    elevation="16"
    target="_blank"
    href="http://127.0.0.1:5500/src/assets/vue2/ControladorVue2.html"
    max-width="344" >
    <v-card-item>
...
<v-row class="my-12">
  <v-col cols="12">
    <h2 class="bg-pink-darken-4 pa-4">Vue2 OPTIONS -TEXT HTML</h2>
      <p class="bg-orange-lighten-4 pa-4 mb-4">Acciones concretas de mejoramiento y adecuación del proyecto </p>
  </v-col>
  <!-- ****************************************** -->
